...
echo color("green","[]            PERAK WANI  	    []\n");
echo color("yellow","[]     CREATOR : XI-ON-MAN-SIT   []\n");
...
function change(){
        ...
        sleep(3);
        $alt01 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOOD0906"}');
        ...
        sleep(3);
        $alt02 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD0906"}');
        ...
        sleep(3);
        $goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD0906"}');
