...
// function change(){
        ...
        echo "\n".color("nevy","🔒▶️ Claim voucher DOA ");
        echo "\n".color("blue","⏳▶︄Yang Sabar Iya Suhu....");
        for($a=1;$a<=3;$a++){
        echo color("blue",".");
        sleep(35);
        }
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("nevy","🔒▶️ Claim voucher USAHA ");
        echo "\n".color("blue","⏳▶︄Yang Sabar Iya Suhu....");
        for($a=1;$a<=3;$a++){
        echo color("blue",".");
        sleep(30);
        }
        $code2 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PESANGOFOOD2206"}');
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("nevy","🔒▶️ Claim voucher IKHTIAR");
        echo "\n".color("blue","⏳▶︄Yang Sabar Iya Suhu....");
        for($a=1;$a<=3;$a++){
        echo color("blue",".");
        sleep(25);
        }
        $code3 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"MAKANGOFOOD2206"}');
        $message = fetch_value($code3,'"message":"','"');
        echo "\n".color("pink","🔓▶️ Message: ".$message);
        echo "\n".color("nevy","🔒▶️ Claim voucher TAWAKAL ");
        echo "\n".color("blue","⏳ ▶︄Yang Sabar Iya Suhu....");
        for($a=1;$a<=3;$a++){
        echo color("blue",".");
        sleep(5);
        }
        $code4 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code"PAKEGOFOOD2206"}');
